...
extension LaunchAdImageView {
    
    func setImage(with url: String, options: LaunchAdImageOptions, completion: LaunchClosure?) {
    ...
    /// 设置Gif图片
    func setGifImage(named name: String, completion: LaunchClosure?) {
...
extension UIImage {
    ...
    class func gif(name: String) -> UIImage? {
        ...
        guard let bundleURL = Bundle.main.url(forResource: nameStr, withExtension: "gif") else {
            return nil
        }
