...
class CardMapLayout: UICollectionViewFlowLayout {
    private let scaleFactor: CGFloat = 0.0005 // 缩放因子
    ...
    // 该方法默认返回false 返回true frame发生改变就重新布局 内部会重新调用prepare和 layoutAttributesForElementsInRect
