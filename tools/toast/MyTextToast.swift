...
class MyTextToast: UIView {
    ...
    func initEventHendle() {
        NotificationCenter.default.addObserver(self, selector: #selector(keyboardWillShow(aNotificaion:)), name: UIResponder.keyboardWillShowNotification, object: nil)
    ...
    @objc func keyboardWillShow(aNotificaion: Notification) {
        let userInfo = aNotificaion.userInfo
    ...
    override func layoutSubviews() {
        ...
        let constraintSize = CGSize(width: superWidth - 40, height: CGFloat.greatestFiniteMagnitude)
